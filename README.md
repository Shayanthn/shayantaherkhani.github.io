<div align="center">
  ...
  *I'm someone who can't stop exploring.*
  ...
  <p>
    ...
    <a href="https://youtube.com/@shayanthn" target="_blank">
      <img src="https://img.shields.io/badge/YouTube-FF0000?style=for-the-badge&logo=youtube&logoColor=white" alt="YouTube"/>
    </a>
    <a href="https://medium.com/@shayanthn78" target="_blank">
...
-   ✨ **Particle Background:** Interactive floating particles with neural network connections.
-   🖱️ **Custom Cursor:** Sleek dot + ring cursor with hover effects.
-   ⌨️ **Typing Effect:** Animated bio text with typewriter effect.
-   🟢 **Status Indicator:** Availability indicator on avatar.
-   💫 **Ripple Effect:** Material-style click animations on buttons.
-   🎨 **Colored Icon Hovers:** Brand-colored icons on hover (YouTube red, LinkedIn blue, etc.)
...
| **✨ Animations** | `CSS Transforms`, `requestAnimationFrame`, `Canvas API` |
